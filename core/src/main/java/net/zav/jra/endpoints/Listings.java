...
import net.zav.jra.models.*;
import net.zav.jra.models._json.JSONDuplicate;
import net.zav.jra.models._json.JSONListing;
import net.zav.jra.models._json.JSONSubmission;
import net.zav.jra.models._json.JSONTrendingSubreddits;
...
public abstract class Listings {
     ...
     */
    @Nonnull
    public static QueryGet<Submission> getComments(AbstractClient client, Function<Thing, ? extends AbstractLink> mapper, String subreddit, String article) {
        return new QueryGet<>(
     ...
     */
    @Nonnull
    public static QueryGet<Submission> getComments(AbstractClient client, Function<Thing, ? extends AbstractLink> mapper, String article) {
        return new QueryGet<>(
                source -> JSONSubmission.from(source, mapper),
                client,
     ...
     */
    @Nonnull
    public static QueryGet<Duplicate> getDuplicates(AbstractClient client, Function<Thing, ? extends AbstractLink> mapper, String article) {
        return new QueryGet<>(
     ...
     */
    @Nonnull
    public static QueryGet<Submission> getRandomSubmission(AbstractClient client, Function<Thing, ? extends AbstractLink> mapper, String subreddit) {
        return new QueryGet<>(
                source -> JSONSubmission.from(source, mapper),
                client,
     ...
     */
    @Nonnull
    public static QueryGet<Submission> getRandomSubmission(AbstractClient client, Function<Thing, ? extends AbstractLink> mapper) {
        return new QueryGet<>(
                source -> JSONSubmission.from(source, mapper),
                client,
                Endpoint.GET_RANDOM
