...
import net.zav.jra.endpoints.Account;
import net.zav.jra.endpoints.Listings;
import net.zav.jra.endpoints.Subreddits;
...
public abstract class Client extends ClientTOP{
    ...
    @Override
    public net.zav.jra.Account getAccount(String name, Parameter... params) throws InterruptedException, IOException {
        QueryGet<net.zav.jra.Account> query = Users.getAccount(this, () -> net.zav.jra.Account.from(this), name);
